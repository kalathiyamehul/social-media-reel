    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-10 mt-8">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full focus-visible:outline-none">
        ...
        <TabsContent value="overview" className="space-y-6 focus-visible:outline-none">
          {(!profile?.instagramHandle || !profile?.facebookPageUrl || !profile?.linkedInHandle) && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              {!profile?.facebookPageUrl && (
                <Card className="bg-gradient-to-br from-blue-500/5 to-cyan-500/5 border-blue-500/20 overflow-hidden relative">
                  ...
                  <CardHeader className="pb-3">
                    ...
                    <CardDescription className="text-xs">
                      Track ads and page performance.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="relative z-10">
                    <div className="flex flex-col gap-2">
              ...
              {!profile?.linkedInHandle && (
                <Card className="bg-gradient-to-br from-sky-500/5 to-indigo-500/5 border-sky-500/20 overflow-hidden relative">
                  <div className="absolute right-0 top-0 opacity-10 translate-x-1/4 -translate-y-1/4">
                    <Linkedin className="h-48 w-48 text-sky-500" />
                  </div>
                  <CardHeader className="pb-3">
                    <CardTitle className="text-lg flex items-center gap-2">
                    ...
                    <div className="flex flex-col gap-2">
                      <input
                        ...
                        onKeyDown={(e) => {
                          if (e.key === 'Enter') {
                            const val = (e.target as HTMLInputElement).value;
                            if (val) onSaveField?.('linkedInHandle', val);
                          }
                        }}
                      />
                      <Button
                        ...
                        onClick={() => {
                          const el = document.getElementById('inline-linkedin') as HTMLInputElement;
                          if (el?.value) onSaveField?.('linkedInHandle', el.value);
                        }}
                      >
                        Connect
                      </Button>
