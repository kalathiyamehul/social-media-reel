        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground flex flex-wrap items-center gap-3">
                        Prompt Templates
                        <Badge variant="outline" className="text-[9px] sm:text-[10px] uppercase tracking-widest text-primary dark:text-primary border-primary/20 bg-primary/5 px-2">Intelligence</Badge>
                    </h1>
                ...
                <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                    <DialogTrigger asChild>
                        <Button onClick={openNew} className="w-full sm:w-auto rounded-xl h-10 sm:h-11 bg-gradient-to-r from-primary to-primary hover:from-primary hover:to-primary border-0 gap-2 shadow-lg shadow-primary/20 px-6 text-xs sm:text-sm">
                    ...
                    <DialogContent className="w-[95vw] sm:max-w-[750px] max-h-[90vh] flex flex-col glass-strong border-border/50 rounded-2xl p-0 overflow-hidden">
                        <div className="shrink-0 bg-gradient-to-br from-primary/15 via-primary/10 to-transparent p-5 sm:p-7 border-b border-white/5 relative overflow-hidden">
                            ...
                            <div className="p-5 sm:p-10 space-y-10">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="grid gap-2.5">
                                            ...
                                            <Input
                                                ...
                                                className="rounded-xl bg-foreground/[0.03] border-border/50 h-12 text-sm focus:ring-primary/50 focus:border-primary/30 transition-all font-medium"
                                            />
                                        </div>
                                        <div className="grid gap-2.5">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center justify-between border-b border-border/40 pb-2">
                                        ...
                                        <Badge variant="outline" className="text-[8px] uppercase font-black border-primary/30 text-primary bg-primary/5 px-2">AI Pilot</Badge>
                                    </div>

                                    <div className="relative group p-6 rounded-2xl bg-gradient-to-br from-primary/[0.03] to-primary/[0.03] border border-primary/10 hover:border-primary/20 transition-all duration-300">
                                        ...
                                        <div className="space-y-4 relative z-10">
                                            <div className="space-y-2">
                                                <Label htmlFor="brand-desc" className="text-[10px] font-bold text-primary uppercase tracking-widest px-1">Describe your Brand or Objective</Label>
                                                <Textarea
                                                    id="brand-desc"
                                                    placeholder="e.g. A high-end demi-fine jewellery brand in India specializing in anti-tarnish gold plating..."
                                                    value={description}
                                                    onChange={(e) => setDescription(e.target.value)}
                                                    className="min-h-[100px] rounded-xl bg-background/50 border-border/50 resize-none p-4 text-sm focus:ring-primary/50 leading-relaxed font-medium"
                                                />
                                            </div>
                                            ...
                                            <Button
                                                ...
                                                className="w-full rounded-xl border-primary/30 hover:bg-primary/10 text-primary text-xs font-bold gap-2 h-11 transition-all duration-300 active:scale-95 shadow-sm"
                                            >
                                                {isGenerating ? (
                                ...
                                {pendingGenerated && (
                                    <div className="space-y-4 p-5 rounded-2xl bg-primary/5 border border-primary/20 animate-in zoom-in duration-300">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                <Sparkles className="h-4 w-4 text-primary" />
                                                <span className="text-xs font-bold text-primary">New Strategy Preview</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <Button
                                                    size="sm"
                                                    ...
                                                    className="h-8 rounded-lg text-[10px] font-bold text-muted-foreground hover:text-destructive"
                                                >
                                                    Discard
                                                </Button>
                                                <Button
                                                    ...
                                                    className="h-8 rounded-lg text-[10px] font-bold bg-primary hover:bg-primary text-primary-foreground px-4"
                                                >
                                                    Apply to Template
                                                </Button>
                                            </div>
                                        ...
                                        <div className="grid gap-3 opacity-60 pointer-events-none scale-[0.98] origin-top">
                                            <div className="bg-background/40 rounded-lg p-3 border border-border/30">
                                                <p className="text-[9px] font-black text-primary/50 uppercase tracking-widest mb-1">Analysis</p>
                                    ...
                                    <div className="grid gap-8">
                                        <div className="grid gap-3">
                                            ...
                                            <Textarea
                                                ...
                                                className="min-h-[220px] rounded-2xl bg-foreground/[0.02] border-border/50 resize-none p-5 leading-relaxed font-mono text-[12px] focus:ring-primary/20 shadow-inner"
                                            />
                                        </div>
                        ...
                        <div className="shrink-0 p-3 sm:p-4 bg-foreground/[0.02] border-t border-border/30 flex flex-col sm:flex-row justify-end gap-2 px-6">
                            ...
                            <Button
                                ...
                                className="w-full sm:w-auto rounded-xl h-9 sm:h-10 min-w-[120px] bg-gradient-to-r from-primary to-primary hover:from-primary hover:to-primary border-0 shadow-lg shadow-primary/10 text-[11px] font-semibold"
                            >
                                {saving ? (
                                    <>
            ...
            <div className="relative w-full sm:max-w-md group">
                <Input
                    ...
                    className="pl-9 h-10 sm:h-11 rounded-xl glass border-border/50 focus:ring-1 focus:ring-primary/50 bg-foreground/[0.02] text-xs sm:text-sm"
                />
            ...
            {isLoading ? (
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-2">
                    {filteredTemplates.map((template) => (
                        <Card key={template.templateName} className="group glass border-border rounded-2xl overflow-hidden transition-all duration-500 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 flex flex-col">
                            <CardHeader className="pb-4 relative">
                                <div className="flex items-start justify-between">
                                    <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-primary/10 border border-primary/20 text-primary shadow-inner group-hover:scale-105 transition-transform duration-500">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <Button
                                            ...
                                            className="h-10 w-10 rounded-xl text-muted-foreground hover:text-destructive hover:bg-destructive/10 glass border border-transparent hover:border-destructive/20"
                                        >
                                ...
                                <div className="mt-4">
                                    <CardTitle className="text-xl text-foreground font-bold group-hover:text-primary dark:group-hover:text-primary transition-colors uppercase tracking-tight">{template.templateName}</CardTitle>
                            ...
                            <CardContent className="flex-1 space-y-4">
                                <div className="space-y-1.5">
                                    <p className="text-[10px] font-bold text-primary uppercase tracking-widest pl-1">Analysis Focus</p>
                                ...
                                <div className="space-y-1.5">
                                    <p className="text-[10px] font-bold text-primary uppercase tracking-widest pl-1">Concept Guidance</p>
                ...
                <div className="flex flex-col items-center justify-center py-32 rounded-3xl glass border-border/50 text-center bg-gradient-to-b from-transparent to-primary/5 shadow-2xl shadow-inner">
                    <div className="h-20 w-20 rounded-3xl bg-primary/10 border border-primary/20 flex items-center justify-center mb-6 shadow-xl shadow-primary/5 animate-pulse">
                    ...
                    {!searchQuery && (
                        <Button onClick={openNew} className="mt-10 rounded-xl h-12 px-10 bg-gradient-to-r from-primary to-primary hover:from-primary hover:to-primary border-0 shadow-lg shadow-primary/20">
