            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                    ...
                    <DialogContent className="w-[95vw] sm:max-w-[750px] max-h-[90vh] glass-strong border-border/50 rounded-2xl p-0 overflow-hidden">
                        <div className="bg-gradient-to-br from-purple-600/15 via-indigo-500/10 to-transparent p-5 sm:p-7 border-b border-white/5 relative overflow-hidden">
                            {/* Decorative background flare */}
                            <div className="absolute -top-10 -right-10 h-32 w-32 bg-purple-500/10 rounded-full blur-3xl" />
                            ...
                            <div className="p-5 sm:p-10 space-y-10">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="grid gap-2.5">
                                            ...
                                            <Input
                                                ...
                                                className="rounded-xl bg-foreground/[0.03] border-border/50 h-12 text-sm focus:ring-purple-500/50 focus:border-purple-500/30 transition-all font-medium"
                                            />
                                        </div>
                                        <div className="grid gap-2.5">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center justify-between border-b border-border/40 pb-2">
                                        ...
                                        <Badge variant="outline" className="text-[8px] uppercase font-black border-indigo-500/30 text-indigo-400 bg-indigo-500/5 px-2">AI Pilot</Badge>
                                    </div>

                                    <div className="relative group p-6 rounded-2xl bg-gradient-to-br from-purple-600/[0.03] to-indigo-600/[0.03] border border-purple-500/10 hover:border-purple-500/20 transition-all duration-300">
                                        ...
                                        <div className="space-y-4 relative z-10">
                                            <div className="space-y-2">
                                                <Label htmlFor="brand-desc" className="text-[10px] font-bold text-indigo-400 uppercase tracking-widest px-1">Describe your Brand or Objective</Label>
                                                <Textarea
                                                    id="brand-desc"
                                                    placeholder="e.g. A high-end demi-fine jewellery brand in India specializing in anti-tarnish gold plating..."
                                                    value={description}
                                                    onChange={(e) => setDescription(e.target.value)}
                                                    className="min-h-[100px] rounded-xl bg-background/50 border-border/50 resize-none p-4 text-sm focus:ring-purple-500/50 leading-relaxed font-medium"
                                                />
                                            </div>
                                            ...
                                            <Button
                                                ...
                                                className="w-full rounded-xl border-purple-500/30 hover:bg-purple-500/10 text-purple-400 text-xs font-bold gap-2 h-11 transition-all duration-300 active:scale-95 shadow-sm"
                                            >
                                                {isGenerating ? (
                                ...
                                {pendingGenerated && (
                                    <div className="space-y-4 p-5 rounded-2xl bg-indigo-500/5 border border-indigo-500/20 animate-in zoom-in duration-300">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                <Sparkles className="h-4 w-4 text-indigo-400" />
                                                <span className="text-xs font-bold text-indigo-300">New Strategy Preview</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <Button
                                                    size="sm"
                                                ...
                                                <Button
                                                    ...
                                                    className="h-8 rounded-lg text-[10px] font-bold bg-indigo-500 hover:bg-indigo-600 text-white px-4"
                                                >
                                                    Apply to Template
                                                </Button>
                                            </div>
                                        ...
                                        <div className="grid gap-3 opacity-60 pointer-events-none scale-[0.98] origin-top">
                                            <div className="bg-background/40 rounded-lg p-3 border border-border/30">
                                                <p className="text-[9px] font-black text-indigo-400/50 uppercase tracking-widest mb-1">Analysis</p>
                                    ...
                                    <div className="grid gap-8">
                                        <div className="grid gap-3">
                                            ...
                                            <Textarea
                                                ...
                                                className="min-h-[220px] rounded-2xl bg-foreground/[0.02] border-border/50 resize-none p-5 leading-relaxed font-mono text-[12px] focus:ring-purple-500/20 shadow-inner"
                                            />
                                        </div>
