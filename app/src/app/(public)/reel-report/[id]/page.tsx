...
export default function PublicReelReportPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-20 pt-6 px-4 animate-in fade-in duration-500">
      ...
      {/* Header Banner */}
      <div className="flex flex-col sm:flex-row items-center justify-between bg-gradient-to-r from-orange-500/10 to-red-600/10 border border-orange-500/20 rounded-2xl p-4 sm:p-6 gap-4 text-center sm:text-left">
        <div>
        ...
        <Button asChild className="bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white rounded-xl shadow-lg shadow-orange-500/20 shrink-0">
