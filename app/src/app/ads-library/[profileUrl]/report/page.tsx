...
export default function AdReportPage({ params }: { params: Promise<{ profileUrl: string }> }) {
    ...
    return (
      <div className="flex h-[60vh] items-center justify-center flex-col gap-5">
        ...
        <div className="text-center">
          <h2 className="text-lg font-semibold text-white">No Report Found</h2>
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Report Card */}
      <div className="rounded-2xl border border-violet-500/20 bg-gradient-to-br from-violet-950/40 via-black/60 to-blue-950/40 overflow-hidden shadow-2xl shadow-violet-900/20">
