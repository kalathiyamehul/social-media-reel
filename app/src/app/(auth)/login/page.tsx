    ...
    <div className="min-h-screen flex items-center justify-center bg-[#050508] px-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">Instagram Virality Engine</h1>
          <p className="text-sm text-muted-foreground mt-1">Sign in to your intelligence dashboard</p>
        </div>
